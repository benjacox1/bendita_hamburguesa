(function(){
  ...
  function showError(msg){ err.textContent = msg || 'Error'; err.style.display = 'block'; }
  function clearError(){ err.style.display = 'none'; err.textContent=''; }
  function nextUrl(){ const u = new URL(location.href); return u.searchParams.get('next') || './index.html'; }
